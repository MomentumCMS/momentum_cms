 ...
 * https://github.com/marcancajas/nestedSortable/tree/2.0alpha
 * Depends on:
...
(function ($) {
  ...
  $.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
    ...
    options: {
      ...
      branchClass: 'ui-nestedSortable-branch',
      collapsedClass: 'ui-nestedSortable-collapsed',
      disableNestingClass: 'ui-nestedSortable-no-nesting',
      errorClass: 'ui-nestedSortable-error',
      expandedClass: 'ui-nestedSortable-expanded',
      hoveringClass: 'ui-nestedSortable-hovering',
      leafClass: 'ui-nestedSortable-leaf',
      disabledClass: 'ui-nestedSortable-disabled'
    },

    _create: function () {
      this.element.data('ui-sortable', this.element.data('ui-nestedSortable'));
